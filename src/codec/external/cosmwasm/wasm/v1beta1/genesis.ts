...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.genMsgs = (object.genMsgs ?? []).map((e: any) =>
      GenesisState_GenMsgs.fromJSON(e),
    )
    return message
  },
  ...
  fromJSON(object: any): Code {
    ...
    message.codeBytes =
      object.codeBytes !== undefined && object.codeBytes !== null
        ...
        : new Uint8Array()
    message.pinned =
      object.pinned !== undefined && object.pinned !== null
        ? Boolean(object.pinned)
        : false
    return message
  },
  ...
  fromJSON(object: any): Contract {
    ...
    message.contractInfo =
      object.contractInfo !== undefined && object.contractInfo !== null
        ...
        : undefined
    message.contractState = (object.contractState ?? []).map((e: any) =>
      Model.fromJSON(e),
    )
    return message
  },
...
export const Sequence = {
  ...
  fromJSON(object: any): Sequence {
    const message = { ...baseSequence } as Sequence
    message.idKey =
      object.idKey !== undefined && object.idKey !== null
